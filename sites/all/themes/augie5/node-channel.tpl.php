...
<ul class="list-features clearfix">
	<li><?php 
						  ...
						  <h5><?php print l($feature_1->title, "node/$feature_1->nid", null, null, null, true, true);  ?></h5>
						...
						<?php 
						  ...
						  <h5><?php print l($feature_2->title, "node/$feature_2->nid", null, null, null, true, true);  ?></h5>
						...
						<h5><?php print l($feature_3->title, "node/$feature_3->nid", null, null, null, true, true);  ?></h5>
